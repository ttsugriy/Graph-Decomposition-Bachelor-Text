\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    ...
    \begin{enumerate}
      ...
      \item Виконати Перевірку на Сумісність для рівня 1.
    \end{enumerate}}
    ...
    \STATE{Присвоїти маркер вершині $v$ наступним чином:
      \begin{enumerate}
        ...
        \item Якщо пошук в II. не успішний, то для кожної вершини $u^\prime$ інцидентної $v$ в рівні $k-1$ виконати $Combine(u,u^\prime;i)$, де $i$ - довільна ненульова компонента $u$.
    ...
    \end{enumerate}}
    \ENDFOR{ Тепер усі вершини в рівні $k$ марковано. Виконати Тест на Сумісність для рівня $k$.}
    \ENDFOR
  \end{algorithmic}
\end{algorithm}
